# Tracy built with Zig

This project builds [Tracy](https://github.com/wolfpld/tracy.git)
...
.{
    ...
    .dependencies = .{
        .tracy = .{
            .url = "https://github.com/mitchellh/zig-build-tracy/archive/<git-ref-here>.tar.gz",
